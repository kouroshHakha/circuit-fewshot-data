...
from bb_envs.ngspice.wrappers.two_stage_graph import TwoStageOpenLoop
...
netlist_manager = TwoStageOpenLoop(
    num_process=100, 
    design_netlist='bb_envs/src/bb_envs/ngspice/templates/two_stage_graph/two_stage_graph.cir',
)
...
netlist_skeleton = dict(
    ...
    mp1=dict(type='M', params=dict(is_nmos=False, w=20), terminals=dict(D='net4', G='net4', S='VDD', B='VDD')),
    mp2=dict(type='M', params=dict(is_nmos=False, w=20), terminals=dict(D='net5', G='net4', S='VDD', B='VDD')),
